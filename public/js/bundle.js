...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmViZXJpY2hlIiwiYSI6ImNrc3p5OW9zNzAwMTYyb3FvNmFyOGR4bDYifQ.NuyG-EHtaoNXgQls81YCdw';
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var defaultUrl, url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            defaultUrl = 'http://localhost:3000/api/v1/users/';
            url = type === 'password' ? "".concat(defaultUrl, "updateMyPassword") : "".concat(defaultUrl, "updateMe");
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51JWNPAGCr2CK86XwJer6K6t0cIgpUPmeqB2IEez34MHfizBuh2RIEiCwSrM1XZa87W9PlmFfJeKN5abhktshCB3900xQgihWl5');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              document.querySelector('.btn--save-data').textContent = 'save Data';
